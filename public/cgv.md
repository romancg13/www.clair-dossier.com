...
## Article 2 — Création de compte et souscription

La création de compte est gratuite et s'effectue en ligne via le site clair-dossier.com, avec confirmation par e-mail. Elle permet de créer des dossiers et de déposer des pièces. La souscription à un abonnement est ensuite réalisée par le Client en choisissant un plan parmi les offres proposées.

L'abonnement est souscrit sans engagement de durée minimale. Le Client peut résilier à tout moment, la résiliation prenant effet au terme de la période de facturation en cours.
...
À la résiliation, le Client peut demander la récupération de ses données. Une copie lui est transmise sur demande adressée à contact.clairdossier@icloud.com, dans un délai de 30 jours, puis les données sont supprimées ou anonymisées selon les modalités prévues à la politique de confidentialité.

## Article 5 — Niveau de service

ClairDossier met en œuvre les moyens raisonnables pour assurer la disponibilité et le bon fonctionnement du Service. Des opérations de maintenance peuvent occasionner des interruptions temporaires ; ClairDossier s'efforce de les annoncer à l'avance et d'en limiter la durée. Le Service est fourni sans garantie de disponibilité chiffrée.

## Article 6 — Traitement des dossiers
...
ClairDossier ne saurait être tenue responsable des décisions prises par le Client, ni de l'usage fait des dossiers structurés via le Service après leur transmission par le Client à un tiers.
