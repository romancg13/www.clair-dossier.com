...
| `.claude/agents/support-agent.md` | support-agent | Read | sonnet | Auto-Support (IV.14) : résout connexion, mot de passe, abonnement, facture, upload, fonctionnalité, export, quota ; sinon oriente vers Service Assistance ClairDossier — 04 91 95 90 32. | Se présente comme « ClairDossier IA » ; escalade vers 04 91 95 90 32 + Human Exception Inbox |
